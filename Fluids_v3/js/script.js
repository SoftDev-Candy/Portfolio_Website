...
const canvas = document.getElementById('fx-fluid') || document.getElementById('fx-dust') || document.getElementsByTagName('canvas')[0];
const FLUIDS_ASSET_BASE = window.__FLUIDS_ASSET_BASE__ || './Fluids_v3/js/';
function resolveFluidAsset (path) {
    if (/^(https?:|data:|blob:|\/)/i.test(path)) return path;
    return FLUIDS_ASSET_BASE + path;
}
resizeCanvas();
...
let ditheringTexture = createTextureAsync(resolveFluidAsset('LDR_LLL1_0.png'));
